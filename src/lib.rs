...
pub mod handlers {
    ...
    use crate::{ip_to_number, is_eu_country, lookup_ipv4_country, lookup_ipv6_country};

    #[get("/")]
    pub async fn get_ip_address(request: actix_web::HttpRequest) -> impl Responder {
    ...
    #[get("/{ip_address}")]
    pub async fn print_ip_address(ip_address: actix_web::web::Path<String>) -> impl Responder {
...
pub mod tooling {
    ...
    pub async fn download_databases() -> Result<(), Error> {
        let ipv4_url =
